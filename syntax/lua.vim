...
elseif lua_version > 5 || (lua_version == 5 && lua_subversion >= 1)
  ...
  syn region  luaComment        matchgroup=luaComment start="--\[\z(=*\)\[" end="\]\z1\]" fold contains=luaTodo,@Spell
endif

" First line may start with #!
syn match luaComment "\%^#!.*"

if exists("g:lua_catch_errors")
...
syn region luaFunctionBlock transparent matchgroup=luaFunction start="\<function\>" end="\<end\>" fold contains=ALLBUT,luaTodo,luaSpecial,luaCond,luaCondElseif,luaCondEnd,luaRepeat
...
" do ... end
syn region luaBlock transparent matchgroup=luaStatement start="\<do\>" end="\<end\>" fold contains=ALLBUT,luaTodo,luaSpecial,luaCond,luaCondElseif,luaCondEnd,luaRepeat
...
" other keywords
syn keyword luaStatement return local in break
...
" tables
syn region  luaTableBlock transparent matchgroup=luaTable start="{" end="}" fold contains=ALLBUT,luaTodo,luaSpecial,luaCond,luaCondElseif,luaCondEnd,luaCondStart,luaBlock,luaRepeatBlock,luaRepeat,luaStatement
