...
syn match rstTitle ".\{2,120}\n\(\.\{3,120}\|=\{3,120}\|-\{3,120}\|=\{3,120}\|`\{3,120}\|:\{3,120}\|'\{3,120}\|\"\{3,120}\|\~\{3,120}\|\^\{3,120}\|_\{3,120}\|\*\{3,120}\|+\{3,120}\|#\{3,120}\|<\{3,120}\|>\{3,120}\)\w*$"
" [-=`:'"~^_*+#<>]
...
syn region rstHtmlBlock start="^\.\. 2html::.*\n\(\s*\n\)\{-}\z(\s\+\)" skip="^$" end="^\z1\@!" fold 
